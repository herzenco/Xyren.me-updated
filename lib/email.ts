    ...
    html: `
      <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <table style="width:100%; border-collapse: collapse;">
          <tr><td style="padding:6px 0"><strong>Name</strong></td><td>${submission.name}</td></tr>
          <tr><td style="padding:6px 0"><strong>Email</strong></td><td>${submission.email}</td></tr>
          <tr><td style="padding:6px 0"><strong>Phone</strong></td><td>${submission.phone || '—'}</td></tr>
          <tr><td style="padding:6px 0"><strong>Business</strong></td><td>${submission.business || '—'}</td></tr>
          <tr><td style="padding:6px 0"><strong>Service</strong></td><td>${submission.service || '—'}</td></tr>
        </table>
        <h3>Message</h3>
